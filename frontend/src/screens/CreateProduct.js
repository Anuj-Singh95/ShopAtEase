        ...
        <form onSubmit={submitHandler}>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={productNameStateChangeHandler}
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={descriptionStateChangeHandler}
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              name="price"
              value={priceState}
              onChange={priceStateChangeHandler}
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              name="category"
              value={categoryState}
              onChange={categoryStateChangeHandler}
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              name="stocks"
              value={stockState}
              onChange={stockStateChangeHandler}
            />
          </div>
          <div className="mb-3">
